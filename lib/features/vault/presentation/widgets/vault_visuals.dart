...
abstract final class VaultVisuals {
  ...
  static const List<VaultIconChoice> iconChoices = <VaultIconChoice>[
    VaultIconChoice(
      name: 'shield',
      icon: Icons.shield,
      paletteColor: AppColors.brandRed,
    ),
    VaultIconChoice(
      name: 'folder',
      icon: Icons.folder,
      paletteColor: AppColors.vaultPeach,
    ),
    VaultIconChoice(
      name: 'cloud',
      icon: Icons.cloud,
      paletteColor: AppColors.vaultBlue,
    ),
    VaultIconChoice(
      name: 'code',
      icon: Icons.code,
      paletteColor: AppColors.positiveAccent,
    ),
    VaultIconChoice(
      name: 'database',
      icon: Icons.storage,
      paletteColor: AppColors.vaultSlate,
    ),
    VaultIconChoice(
      name: 'key',
      icon: Icons.vpn_key,
    ...
    VaultIconChoice(
      ...
      paletteColor: AppColors.vaultViolet,
    ),
    VaultIconChoice(
      name: 'credit_card',
    ...
    VaultIconChoice(
      name: 'payments',
      icon: Icons.payments,
      paletteColor: AppColors.premiumAmber,
    ),
    VaultIconChoice(
      name: 'computer',
      icon: Icons.computer,
