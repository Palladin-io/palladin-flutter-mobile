...
abstract final class AgentVisibilityProjector {
  ...
  static Map<String, dynamic> grantPayload({
    ...
    for (final requestedId in approvedFieldIds.toSet()) {
      ...
      final access = policy.fields[policyId];
