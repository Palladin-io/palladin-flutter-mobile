...
/// Confirmation bottom sheet shown before approving a pending agent.
///
/// Resolves to `true` when the user confirms, `false` (or `null`) when
/// they cancel or dismiss without confirming.
class ApproveAgentSheet extends StatelessWidget {
  const ApproveAgentSheet({super.key, required this.agentName});
  ...
  static Future<bool> show(BuildContext context, String agentName) async {
    final confirmed = await showModalBottomSheet<bool>(
      ...
      builder: (_) => ApproveAgentSheet(agentName: agentName),
    );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                l10n.agentsApproveConfirmTitle,
                style: TextStyle(
              ...
              Text(
                l10n.agentsApproveConfirmBody(agentName),
                style: TextStyle(
