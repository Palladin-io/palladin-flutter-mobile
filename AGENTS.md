...
| `SheetSurface` | `lib/core/widgets/sheet_surface.dart` | Compact titled surface used by the shared startup/settings consent bottom sheet; max width 640, optional close; host owns modal semantics. Params: `title`, `child`, `showClose`, `onClose` |
