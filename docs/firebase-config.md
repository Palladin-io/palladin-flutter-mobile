...
fragment; a self-hosted base path is supported. Trailing slashes are removed
so REST, public assets and SignalR use the same base. See the README for ignored JSON
